...
int main(void)
{
  ...
  //hagl_put_text(L"policja", 40, 55, YELLOW, font6x9);
  ...
  while (1)
  {
	 ...
	 // printf("p = %.1f hPa\n", lps25hb_read_pressure());
	  ...
	  lcd_copy();
	  //for (int i = 0; i < 8; i++) {
	  //hagl_draw_rounded_rectangle(2+i, 2+i, 158-i, 126-i, 8-i, rgb565(0, 0, i*16)); //konfiguracja biblioteki HAGL do rysowania
	  //}
